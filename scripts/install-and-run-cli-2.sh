...
echo machineName,starttime,endtime,buildtime:$machineName,$PullStartTime,$PullEndTime,$pulltime >> /mnt/azurefiles/$today/Scenario1-500/acr-build-output-time.log
